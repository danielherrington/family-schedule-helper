...
export const SyncReviewModal: React.FC = () => {
  ...
  return (
    <Modal
      ...
      title="Sync Review & Push"
      subtitle="Protected Safe Mode: Review local changes before committing to Google Calendar."
      icon={<ShieldCheck size={22} color="var(--primary)" />}
      badge={countBadge}
      size="lg"
      footer={
