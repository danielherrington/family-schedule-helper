...
export const SchoolInboxModal: React.FC = () => {
  ...
  return (
    <Modal
      isOpen={isSchoolInboxOpen}
      onClose={() => setIsSchoolInboxOpen(false)}
      size="lg"
      icon={<GraduationCap size={22} color="#d97706" />}
      title="School Calendar & Gmail Ingestion"
      badge={
        <span 
          style={{
            fontSize: '0.65rem',
      ...
      subtitle="Automated Gmail inbox scanning & early dismissal auto-detection for Lehrman Community Day School"
      headerContent={
